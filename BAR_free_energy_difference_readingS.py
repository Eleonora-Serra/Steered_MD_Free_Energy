...
from Free_energy_estimators.cumulative_work_first_app import work_at_different_s_values_first_app
...
output_files_path_binding = wdir+'/binding/Colvar_%sns_binding_newPath/work_different_S_firstApp/'%(sim_time)
output_files_path_unbinding = wdir+'/unbinding/Colvar_%sns_unbinding_newPath/work_different_S_firstApp/'%(sim_time)
...
if make_cumulative_work_files == True:
    ...
    work_at_different_s_values_first_app(replicas=replicas,
                            input_files_path=input_files_path_binding,
                            colvar_file=colvar_files_prefix_bind,
    ...
    work_at_different_s_values_first_app(replicas=replicas,
                            ...
                            colvar_file=colvar_files_prefix_unb,
