...
##Function to read the work_s files with cumulative work and create a file with replicas's work values for each value of s reading the time (Cumulative W at each step)
